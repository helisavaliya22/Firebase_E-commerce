...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("AAA", "onCreate: Who is Register??"+mAuth.getCurrentUser().getEmail());

        btnPRegister.setOnClickListener(v -> emailRegistration());
        ...
        GoogleSignInOptions googleSignInOptions = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("901240375579-5trltge8g939d427ljl73iuroai4grtm.apps.googleusercontent.com")
                .requestEmail()
                .build();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d("AAA", "onComplete: user"+mAuth.getCurrentUser().getEmail());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 100) {
            ...
            if (signInAccountTask.isSuccessful()) {
                ...
                Log.d("AAA", "Google sign in successful ");
                // Display Toast
                displayToast(s);
                        ...
                        mAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Log.e("AAA", "Google sign in Failed due to->"+task.getException().getMessage());
                                }
                            }
                        });
                    }
